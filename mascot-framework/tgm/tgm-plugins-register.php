 ...
 */
require_once ABOGADA_FRAMEWORK_DIR . '/tgm/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'abogada_register_required_plugins' );
 ...
 */
function abogada_register_required_plugins() {
	$plugins_path = ABOGADA_FRAMEWORK_DIR . '/tgm/plugins';
	$server_path = 'https://kodesolution.live/plugins/mascot-core-finora';
	/*
	...
	$plugins = array(
		array(
			'name'         	=> 'Mascot Core - Abogada',
			'slug'         	=> 'mascot-core-abogada',
			'source'       	=> $server_path . 'mascot-core-elementor/mascot-core-abogada.zip',
			'required'     	=> true,
			'version'      	=> '1.0'
		),
		array(
	 ...
	 */
	$config = array(
		'id'           => 'abogada',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		...
		'message'      => '<div class="notice notice-info is-dismissible mt-20">
			...
			<p><strong>Note from Author ' . ABOGADA_AUTHOR . ':</strong> To ensure the latest version of <em>theme required</em> plugins, you must have the latest version of <strong>' . $theme_name . '</strong></p>
