	...
	<?php
	/**
	* abogada_before_footer hook.
	*
	*/
	do_action( 'abogada_before_footer' );
	?>
	<footer id="footer" class="footer <?php echo esc_attr( $footer_classes );?>">
	<?php
		/**
		* abogada_footer_start hook.
		*
		*/
		do_action( 'abogada_footer_start' );
	?>
		<div class="footer-widget-area">
			<?php if ( isset($footer_widget_area) && !empty($footer_widget_area) && mascot_core_abogada_plugin_installed() ) { ?>
	...
	<?php
		/**
		* abogada_footer_end hook.
		*
		*/
		do_action( 'abogada_footer_end' );
	?>
	</footer>
	<?php
	/**
	* abogada_after_footer hook.
	*
	*/
	do_action( 'abogada_after_footer' );
	?>