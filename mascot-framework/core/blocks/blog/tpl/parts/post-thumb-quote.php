<?php
	...
	$quote_author = abogada_get_rwmb_group( 'abogada_' . "blog_mb_pf_quote_settings", 'quote_author' );
	$quote_position = abogada_get_rwmb_group( 'abogada_' . "blog_mb_pf_quote_settings", 'quote_position' );
?>
