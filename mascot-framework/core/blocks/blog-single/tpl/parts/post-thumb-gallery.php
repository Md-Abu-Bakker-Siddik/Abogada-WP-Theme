<?php abogada_enqueue_script_lightgallery(); ?>
<?php abogada_enqueue_script_owl_carousel(); ?>
<?php $gallery_images = abogada_get_rwmb_group_advanced( 'abogada_' . "blog_mb_pf_gallery_settings",  "gallery_images", null, false, 'all', 'large' );?>
