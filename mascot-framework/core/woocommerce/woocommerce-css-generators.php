...
if (!function_exists('abogada_shop_archive_settings_gutter_size')) {
	/**
	 * Generate CSS codes for Shop Column Spacing (Gutter Size) px
	 */
	function abogada_shop_archive_settings_gutter_size() {
		...
		$column_gutter = $abogada_redux_theme_opt[$var_name];
	...
	add_action('abogada_dynamic_css_generator_action', 'abogada_shop_archive_settings_gutter_size');
}


if (!function_exists('abogada_shop_settings_product_price_color')) {
	/**
	 * Generate CSS codes for Product Price Color Color
	 */
	function abogada_shop_settings_product_price_color() {
		global $abogada_redux_theme_opt;
	...
	add_action('abogada_dynamic_css_generator_action', 'abogada_shop_settings_product_price_color');
}


if (!function_exists('abogada_shop_settings_product_on_sale_tag_bg_color')) {
	/**
	 * Generate CSS codes for Product On Sale Tag Background Color
	 */
	function abogada_shop_settings_product_on_sale_tag_bg_color() {
		global $abogada_redux_theme_opt;
	...
	add_action('abogada_dynamic_css_generator_action', 'abogada_shop_settings_product_on_sale_tag_bg_color');
}
