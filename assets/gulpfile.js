...
gulp.task("default", function () {
  gulp.watch("scss/**/*.scss", gulp.series("sass-abogada", "rtl-abogada", "abogada-shop", "rtl-abogada-shop", "sass-custom-admin-abogada"));
});

//Task 1 - scss to css
gulp.task("sass-abogada", function () {
  return gulp
...
gulp.task("rtl-abogada", function () {
  return gulp
...
gulp.task("sass-custom-admin-abogada", function () {
  return gulp
